  ...
  <body>
      ...
      <aside class="aside is-placed-left is-expanded is-dark">
        ...
        <div class="menu is-menu-main">
          ...
          <ul class="menu-list">
			...
			<li>
              <a href="lightingprompts.php" class="has-icon is-active">
                <span class="icon has-update-mark"><i class="mdi mdi-spotlight-beam"></i></span>
					...
					<div class="loader is-loading" style="height: 80px; width: 80px;"></div>
						...
						<div class="prompt-display-section mt-3">
							<div id="promptdata" class="content" >
								<div contentEditable="true" id="innerprompt" class="innerprompt" style="border: 1px solid #b5b5b5; padding: 1rem;">[Subject/Details: german shephard], golden hour, dusk, sunset, sunrise, warm lighting, strong shadows, beams of sunlight, high quality DSLR photo</div>
							</div>
	...
	<script>
		...
		if (promptindex == -1) {
			...
			var datafile = "lightingpromptdata.php";
