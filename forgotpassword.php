  ...
  <body>
    <div id="app">
      ...
      <section class="section">
        <?php
          if (isset($_POST["email"])) { echo "<div id='notify' class='notification is-info  has-text-centered'>If your email was found then a new password has been emailed to you. Don't forget to check your SPAM folder.</div>"; }
        ?>
        <div class="container">
          <div class="columns is-centered">
            <div class="column is-4">
              <form id="login" method="post">
                ...
                <p class="has-text-left has-text-grey mb-3">
                  Enter your email below and a new password will be emailed to you.
                </p>
                <div class="field">
