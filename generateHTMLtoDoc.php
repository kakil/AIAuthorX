...
// Retrieve the HTML content from the form data
$htmlContent = $_POST['htmlContent'];
var_dump($htmlContent);
// Generate the Word Doc using the HTML content
$docGenerator = new HTML_TO_DOC();
$docGenerator->createDoc($htmlContent, 'pagePilot.doc', true);
